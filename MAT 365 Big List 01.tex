    ...
    \subsection{Fundamental group}
        ...
        \subsubsection{Computing fundamental groups}
            ...
            \item \textbf{Properties of lifts:}
                ...
                \item () Given $f:[0,1]\times [0,1]\to B$, there is a unique lifting $\bar f$ of $f$ to $E$ such that $\bar f(0\times 0) = e_0$. Furthermore, if $f$ is a path homotopy, then $\bar f$ is a path homotopy as well.
                \end{enumerate}
            %
